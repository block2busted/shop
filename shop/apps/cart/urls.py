...
from .views import add_product_to_cart, \
...
urlpatterns = [
    ...
    path('add-to-cart/<slug>', add_product_to_cart, name='add-to-cart'),
    path('add-coupon', AddCoupon.as_view(), name='add-coupon'),
    path('remove-from-cart/<slug>', remove_product_from_cart, name='remove-from-cart'),
    path('reduse-amount/<slug>', reduce_amount, name='reduse-amount'),
